...
const (
	FileService_UploadFile_FullMethodName = "/imageProc.FileService/UploadFile"
	FileService_DeleteFile_FullMethodName = "/imageProc.FileService/DeleteFile"
)
...
func (c *fileServiceClient) DeleteFile(ctx context.Context, in *FileDeleteRequest, opts ...grpc.CallOption) (*FileDeleteResponse, error) {
...
func (UnimplementedFileServiceServer) DeleteFile(context.Context, *FileDeleteRequest) (*FileDeleteResponse, error) {
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "imageProc.FileService",
